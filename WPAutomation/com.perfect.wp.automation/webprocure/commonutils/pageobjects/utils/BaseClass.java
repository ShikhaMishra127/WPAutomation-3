...
//        test.info("Logging out");
    ...
    public void vendors_login() throws InterruptedException {
        ...
        passwordField.sendKeys("Welcome@5"); // Stage
...
//        driver.findElement(By.xpath("/html/body/div[5]/div[2]/div/div[2]/button[1]")).click();
        ...
        Thread.sleep(3000);
        // Click on No button
        driver.findElement(By.xpath("/html/body/div[6]/div[2]/div/div[2]/button[1]")).click();
...
//        driver.findElement(By.xpath("//*[@id=\"visiblePass\"]")).sendKeys("Welcome@2");
    ...
    public void create_contract() throws InterruptedException{
...
//        Thread.sleep(3000);
    ...
    public void Create_Payment_voucher()throws InterruptedException{
        ...
        // Select Supplier
        driver.findElement(By.xpath("//input[@placeholder='No supplier selected']")).sendKeys("Shikha Stage Vendor");
...
//        driver.findElement(By.xpath("//label[@for='contractNumberEnable']")).click();
        ...
        driver.findElement(By.xpath("//span[normalize-space()='H6022110']")).click();
    ...
    public void Edit_Payment_Voucher() throws InterruptedException
    {
        driver.manage().timeouts().implicitlyWait(12, TimeUnit.SECONDS);
        WebElement Invoice_tab= driver.findElement(By.xpath("//a[@title='Invoice']"));
        Invoice_tab.click();
