...
public class ContractNavigation {
	 ...
	 * ViewArchivedContracts("View Archived Contracts"); private final String
	 * subMenu;
	 * 
	 * ContractsSubMenu(String levelCode) { this.subMenu = levelCode;
	 * 
	 * } public String getText() { return subMenu; }
	 * 
	 * }
	 */
