...
public class createContractPageObject {
	...
	public void selectContractType(String str) {
		PCDriver.waitForElementToBeClickable(drpDownContractType);
	...
	public void clickNext() {
		...
		try {
			...
			PCDriver.waitForElementToBeClickable(btnNext, Long.parseLong(String.valueOf(5)));
			btnNext.click();
		}
	}
