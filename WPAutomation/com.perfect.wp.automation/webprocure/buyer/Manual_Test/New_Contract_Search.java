...
public class New_Contract_Search extends BaseClass {
    ...
    @Test
    public void new_contract_search() throws InterruptedException, IOException {
...
//        // Go to Contract search page.
            ...
            WebElement search_btn = driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[2]/div[1]/div/div/div[4]/div[4" +
                    "]/button[1]"));
            search_btn.click();
            Thread.sleep(2000);
            ...
            // Reset All
            driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[2]/div[1]/div/div/div[4]/div[4]/button[2]")).click();
            Thread.sleep(2000);
